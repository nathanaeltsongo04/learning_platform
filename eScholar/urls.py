...
urlpatterns = [
    ...
    path('insert_paiement/', views.insert_paiement, name='insert_paiement'),
    path('update_paiement/', views.update_paiement, name='update_paiement'),
    ...
    path('insert_apprenant/', views.insert_apprenant, name='insert_apprenant'),
    path('update_apprenant/', views.update_apprenant, name='update_apprenant'),
    path('domaine_admin/', views.domaine_admin, name='domaine_admin'),
    path('insert_domaine/', views.insert_domaine, name='insert_domaine'),
    path('update_domaine/', views.update_domaine, name='update_domaine'),
    ...
    path('insert_enseignant/', views.insert_enseignant, name='insert_enseignant'),
    path('update_enseignant/', views.update_enseignant, name='update_enseignant'),
    path('insert_formation/', views.insert_formation, name='insert_formation'),
    path('update_formation/', views.update_formation, name='update_formation'),
